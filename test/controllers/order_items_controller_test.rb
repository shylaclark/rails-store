...
class OrderItemsControllerTest < ActionController::TestCase
  ...
  test "should create order_item" do
    assert_difference('OrderItem.count') do
      post :create, order_item: { cart_id: @order_item.cart_id, product_id: @order_item.product_id }
    end
  ...
  test "should update order_item" do
    patch :update, id: @order_item, order_item: { cart_id: @order_item.cart_id, product_id: @order_item.product_id }
    assert_redirected_to order_item_path(assigns(:order_item))
  end
